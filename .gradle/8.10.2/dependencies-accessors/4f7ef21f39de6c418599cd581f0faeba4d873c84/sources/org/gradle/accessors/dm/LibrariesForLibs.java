...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class ImageLibraryAccessors extends SubDependencyFactory {
        private final ImageLabelingLibraryAccessors laccForImageLabelingLibraryAccessors = new ImageLabelingLibraryAccessors(owner);

        public ImageLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>image.labeling</b>
         */
        public ImageLabelingLibraryAccessors getLabeling() {
            return laccForImageLabelingLibraryAccessors;
        }

    }

    public static class ImageLabelingLibraryAccessors extends SubDependencyFactory {
        private final ImageLabelingDefaultLibraryAccessors laccForImageLabelingDefaultLibraryAccessors = new ImageLabelingDefaultLibraryAccessors(owner);

        public ImageLabelingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>common</b> with <b>com.google.mlkit:image-labeling-common</b> coordinates and
         * with version reference <b>imageLabelingCommon</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCommon() {
            return create("image.labeling.common");
        }

        /**
         * Group of libraries at <b>image.labeling.default</b>
         */
        public ImageLabelingDefaultLibraryAccessors getDefault() {
            return laccForImageLabelingDefaultLibraryAccessors;
        }

    }

    public static class ImageLabelingDefaultLibraryAccessors extends SubDependencyFactory {

        public ImageLabelingDefaultLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>common</b> with <b>com.google.mlkit:image-labeling-default-common</b> coordinates and
         * with version reference <b>imageLabelingDefaultCommon</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCommon() {
            return create("image.labeling.default.common");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>imageLabelingCommon</b> with value <b>18.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getImageLabelingCommon() { return getVersion("imageLabelingCommon"); }

        /**
         * Version alias <b>imageLabelingDefaultCommon</b> with value <b>17.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getImageLabelingDefaultCommon() { return getVersion("imageLabelingDefaultCommon"); }
