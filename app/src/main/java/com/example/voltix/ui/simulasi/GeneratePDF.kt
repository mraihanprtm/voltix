...
//fun generatePdf(context: Context, viewModel: SimulasiViewModel = hiltViewModel(), rentang: String, jumlahPeriode: Int) {
fun generatePdf(context: Context, rentang: String, jumlahPeriode: Int) {
